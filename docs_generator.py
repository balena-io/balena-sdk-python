...
def print_functions(baseclass):
	for func_name, blah in inspect.getmembers(baseclass, predicate=inspect.ismethod):
...
def main():
	...
	print doc2md.doc2md(resin.models.application.Application.__doc__, 'Application', type=0)
	...
	print doc2md.doc2md(resin.models.device_os.DeviceOs.__doc__, 'DeviceOs', type=0)
	print_functions(resin.models.device_os.DeviceOs)
	print doc2md.doc2md(resin.models.environment_variables.EnvironmentVariable.__doc__, 'EnvironmentVariable', type=0)
	print doc2md.doc2md(resin.models.environment_variables.ApplicationEnvVariable.__doc__, 'ApplicationEnvVariable', type=0)
	print_functions(resin.models.environment_variables.ApplicationEnvVariable)
	print doc2md.doc2md(resin.models.environment_variables.DeviceEnvVariable.__doc__, 'DeviceEnvVariable', type=0)
