...
class TestDevice(unittest.TestCase):
    ...
    def test_04_start_os_update(self):
        ...
        with self.assertRaises(self.helper.balena_exceptions.DeviceNotFound):
            self.balena.models.device.start_os_update(99999999, "6.0.10")
    ...
    def test_05_is_supported_os_update(self):
        # valid
        self.assertTrue(
            self.balena.models.os.is_supported_os_update("raspberrypi3", "2.15.1+rev2.prod", "6.0.10"))
        self.assertTrue(
            self.balena.models.os.is_supported_os_update("raspberrypi3", "2.15.1+rev2.prod", "2025.7.0"))
        # target < v2.16
        self.assertFalse(
            self.balena.models.os.is_supported_os_update("raspberrypi3", "2.15.1+rev1.prod", "2.15.1+rev2"))
        # source < v2.14
        self.assertFalse(
            self.balena.models.os.is_supported_os_update("raspberrypi3", "2.7.8+rev2.prod", "6.0.10"))
        # downgrade
        self.assertFalse(
            self.balena.models.os.is_supported_os_update("raspberrypi3", "6.0.10", "2.15.1+rev2.prod"))
