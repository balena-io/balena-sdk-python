...
class TestApplication(unittest.TestCase):
    ...
    def test_03_create(self):
        ...
        type(self).app = self.balena.models.application.create('FooBar', 'Raspberry Pi 2', self.helper.default_organization['id'])
        ...
        type(self).app1 = self.balena.models.application.create('FooBar1', 'Raspberry Pi 3', self.helper.default_organization['id'], 'microservices')
