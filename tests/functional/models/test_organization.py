...
class TestOrganization(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertIsInstance(type(self).org1['handle'], string_types)
    ...
    def test_get_by_handle(self):
        ...
        self.assertEqual(self.balena.models.organization.get_by_handle(self.test_org_custom_handle)['id'], type(self).org2['id'])
    ...
    def test_invite_create(self):
        ...
        invite = self.balena.models.organization.invite.create(type(self).org1['id'], 'james@resin.io', 'member', 'Python SDK test invite')
        ...
        with self.assertRaises(self.helper.balena_exceptions.BalenaOrganizationMembershipRoleNotFound):
            invite = self.balena.models.organization.invite.create(type(self).org1['id'], 'james@resin.io', 'member1', 'Python SDK test invite')
