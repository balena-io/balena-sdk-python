...
* Add team-application-access model [Andrea Rosci]
* Add team model [Andrea Rosci]

## v17.1.3 - 2026-06-09

* Alphabetize documentation [Matthew Yarmolinsky]

## v17.1.2 - 2026-06-01

* Clean up documentation for use in docs site [Matthew Yarmolinsky]

## v17.1.1 - 2026-05-11

* Rebuild documentation to include pin_to_os_release() [Ken Bannister]

## v17.1.0 - 2026-04-16

* Add device.pin_to_os_release that supports offline devices [Ken Bannister]

## v17.0.2 - 2026-04-13

* Prohibit OS update to same version via start_os_update() [Ken Bannister]

## v17.0.1 - 2026-04-08

* Disable log tests [Ken Bannister]

## v17.0.0 - 2026-02-17

* Generate docs for doc comment updates [Ken Bannister]
* Rename device.set_supervisor_release to device.pin_to_supervisor_release [Ken Bannister]
* Run OS update in detached mode by default [Ken Bannister]
* Block OS upgrades from current OS < 2.14.0 and target OS < 2.16.0 [Ken Bannister]

## v16.0.0 - 2026-02-10

* Drop support for using short release commits as parameters [Otavio Jacobi]
* No longer support using device short uuid [Otavio Jacobi]

## v15.1.5 - 2026-02-04

* Tests: Make constraint assert raises more flexible [Otavio Jacobi]
* Tests: Allow configuring TEST_MEMBER_ env vars [Otavio Jacobi]
* Tests: Avoid wiping personal organization on organization wipes [Otavio Jacobi]
* Fix linter [Otavio Jacobi]

## v15.1.4 - 2025-05-22

* Do not throw in case of failure to refresh token [Otavio Jacobi]

## v15.1.3 - 2025-05-22

* Tests: Use more realistic statuses for image installs [Thodoris Greasidis]
...
* Add option for detached HUP on start_os_update [jaomaloy]

## v15.0.6 - 2025-02-07

* Clarify/Warn how to setup and run tests [Ken Bannister]

## v15.0.5 - 2025-02-06

* Increase logs tests reliability [Otavio Jacobi]
* Fix broken tar tests URLs to match same from the Node SDK [Otavio Jacobi]
